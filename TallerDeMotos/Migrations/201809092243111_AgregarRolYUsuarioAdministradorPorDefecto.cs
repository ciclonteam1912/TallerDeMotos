namespace TallerDeMotos.Migrations
{
    ...
    public partial class AgregarRolYUsuarioAdministradorPorDefecto : DbMigration
    {
        public override void Up()
        {
            Sql(@"
                ...
                INSERT INTO [dbo].[AspNetRoles] ([Id], [Name], [Descripcion], [Discriminator]) VALUES (N'c2625e46-98d0-42ee-9aec-d38a408ee62c', N'Administrador', NULL, N'IdentityRole')                
        ...
        {
            Sql("DELETE FROM AspNetUserRoles WHERE UserId = '6cb1f3e1-1ca9-48c9-a265-5fb3ba9e1ba1' AND RoleId = 'c2625e46-98d0-42ee-9aec-d38a408ee62c'");
            Sql("DELETE FROM AspNetUsers WHERE Id = '6cb1f3e1-1ca9-48c9-a265-5fb3ba9e1ba1'");
            Sql("DELETE FROM AspNetRoles WHERE Id = 'c2625e46-98d0-42ee-9aec-d38a408ee62c'");
        }
    }
}
