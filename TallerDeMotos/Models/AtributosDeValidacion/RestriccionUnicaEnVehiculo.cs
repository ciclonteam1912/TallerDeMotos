...
{
    public class RestriccionUnicaEnVehiculo : ValidationAttribute
    {
        private ApplicationDbContext _context;

        public RestriccionUnicaEnVehiculo()
        {
